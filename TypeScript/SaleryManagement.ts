...
class ManageSalaries {
    ...
    constructor(m : any[], MinSal : number, MaxSal : number) {
        this.month = m;
        this.minimumSalary = MinSal;
        this.maximumSalary = MaxSal;
    }

    FindMonthWiseSalary = (month: any[], MonthWiseSalary: any[], minimumSalary: number, maximumSalary: number): any[] => {
    ...
    FindEmployeeWithThatSalId = (SalaryData : any[], MapingSaleryToEmployee : any[]) => {
    ...
    FindEmployeeDetailsWithEmpid = (EmployeeId, EmployeeData) => {
...
const obj = new ManageSalaries(["jan", "feb"], 1000, 1500 );
