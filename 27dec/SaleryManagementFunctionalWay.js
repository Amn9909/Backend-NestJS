var findMonthWiseSalary = function (month, MonthWiseSalary, minimumSalary, maximumSalary) {
    var ArrayOfSalaryId = [];
...
var NewFindEmployeeWithThatSalId = function (SalaryData, MapingSaleryToEmployee) {
    var ArrayOfEmpId = [];
...
var NewFindEmployeeDetailsWithEmpid = function (EmployeeId, EmployeeData) {
...
var NewMainFunctionToManageSaleryDetails = function (month, minimumSalary, maximumSalary) {
    ...
    // Calling of function 
    var SalaryData = findMonthWiseSalary(month, MonthWiseSalary, minimumSalary, maximumSalary);
    // console.log("salerydata ",SalaryData);
    var EmployeeId = NewFindEmployeeWithThatSalId(SalaryData, MapingSaleryToEmployee);
    // console.log("employeeid ",EmployeeId);
    var EmployeeDetails = NewFindEmployeeDetailsWithEmpid(EmployeeId, EmployeeData);
